...
class BrightnessService extends Service {
    ...
    get blueLightFilterEnabled() {
        return Utils.exec("hyprshade current").includes("blue-light-filter");
    }

    set blueLightFilterEnabled(enabled) {
        Utils.exec(`hyprshade ${enabled? "on blue-light-filter" : "off"}`);
    }
